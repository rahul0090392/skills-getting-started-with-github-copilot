...
def get_activities(response: Response):
    # Ensure clients don't cache this response so frontends always fetch the latest data
    # Tell clients not to cache so the front-end always requests fresh data
